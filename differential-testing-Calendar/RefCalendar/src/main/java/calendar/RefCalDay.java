...
public class RefCalDay {
	...
	*/
	public RefCalDay(GregorianCalendar cal) {
		...
		setAppts(new LinkedList<RefAppt>());
	...
	/** Sets appts */
	private void setAppts(LinkedList<RefAppt> appts) {
		if(appts!=null)
				this.appts = appts;
	...
	/** Gets appts */
	public LinkedList<RefAppt> getAppts() {
	    return appts;
	}
	...
	public String toString() {
		...
		if (isValid()) {
			...
			Iterator<RefAppt> itr = this.appts.iterator();
		    while(itr.hasNext()) {
...
//			sb.append(this.appts);
	...
	**/
    public String getFullInfomrationApp( Object calday) {
        ...
        Iterator itr = ((RefCalDay)calday).iterator();
        
        String buffer;
        buffer = Integer.toString(((RefCalDay)calday).getMonth())+ "-"; 
        buffer += Integer.toString(((RefCalDay)calday).getDay())+ "-";  
        buffer += Integer.toString(((RefCalDay)calday).getYear())+ " "; 
