...
public class RefDataHandler {
     ...
     **/
    public RefDataHandler() throws IOException {
     ...
     **/
    public RefDataHandler(String fileName) throws IOException {
     ...
     * setting
     **/
    public RefDataHandler(String fileName, boolean autoSave) throws IOException {
     ...
     **/
    public List<RefCalDay> getApptRange(GregorianCalendar firstDay, 
            ...
            LinkedList<RefCalDay> calDays = new LinkedList<RefCalDay>();
            ...
            while (nextDay.before(lastDay)) {
                calDays.add(new RefCalDay(nextDay));
...
//        			System.out.println("today is:" + dateFormat.format(nextDay.getTime()));
//        			System.out.println("apptOccursOn is:" + dateFormat.format(apptOccursOn.getTime()));
//         
                    ...
                    RefCalDay calDayOfAppt = (RefCalDay)calDays.get(daysDifference);
     ...
     **/
    private static LinkedList<GregorianCalendar> getApptOccurences(RefAppt appt, 
     ...
     **/
    private static GregorianCalendar getNextApptOccurrence(RefAppt appt, 
     ...
     **/
    public boolean saveAppt(RefAppt appt) {
        ...
        ((RefAppt) appt).setXmlElement(apptElement);
     ...
     **/
    public boolean deleteAppt(RefAppt appt) {
