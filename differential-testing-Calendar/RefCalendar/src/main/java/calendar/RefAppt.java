...
public class RefAppt{
     ...
     */
    public RefAppt(int startHour, int startMinute, 
     ...
     * @param emailAddress An e-mail address associated with the appointment
     */
    public RefAppt(int startDay, int startMonth, int startYear,
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
			...
			int NumDaysInMonth = RefCalendarUtil.NumDaysInMonth(startYear, startMonth - 1);
